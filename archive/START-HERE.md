...
Everything in this folder is yours. The brief is the PDF and the Google Doc. The research is the companion. The two prompt files are pasted into Claude Code. This file is for the agent.

## Paste this into a fresh Claude Code session, first message, before anything else
...
## The jobs, one plain sentence at the start of a session
...
Fly. Tap. Measure. Read the companies. Pick the person. Write the question. Buy the domain. Open the accounts. Send the emails. Write the cold open. Take the photos. Everything else it can help with, and it should.
