...
## Ground truth (fill in on day one)
- Aircraft: [make, model, take-off weight, payload margin, flight time, camera, sprayer]
- Flight stack: [PX4 / ArduPilot / DJI], control path: [MAVLink + companion / Mobile SDK]
- Camera feed and GPS into my code: [how]
- Ground station: [laptop on WiFi / 4G dongle]
- Diseases seen: [ ] Photos: [yes/no]
- Trees: [n], plot: [size], surroundings: [ ]
- Days available: [n], GPU: [yes/no]

## Where we are
- Level: [1 / 2 / 3]
- Job today: [build / working condition / write / publish / judge / mentor]
- Last log entry: [date, one line]
